    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="/FacultyLoginServlet" method="post" >
                <h1>Teacher Login</h1>
                <input type="text" id="facultyid" name="facultyid" placeholder="FacultyID" />
                <input type="password" id="faculty_pass" name="faculty_pass" placeholder="Password" />
                <button>Login</button>
            </form>
        </div>
        <div class="form-container sign-in-container">
         ...
         <input type="text" id="studentid" name="studentid" placeholder="studentID" />
                  <input type="password" id="student_pass" name="student_pass" placeholder="Password" />
                <button>Login</button>
            </form>
        </div>
